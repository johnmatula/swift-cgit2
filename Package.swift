...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "OpenSSL",
      url: "https://github.com/johnmatula/swift-cgit2/releases/download/v1.1.1/OpenSSL.xcframework.zip",
      checksum: "65afedb6e49bfc58dbb785ff771592c3f8b093e595a11c99b271ece92d400fda"
    ),
    .binaryTarget(
      name: "libgit2",
      url: "https://github.com/johnmatula/swift-cgit2/releases/download/v1.1.1/libgit2.xcframework.zip",
      checksum: "433fc5d4cb892325b4469eadf1eda33ede2663340cc36857484d166cc0ad5a99"
    ),
    .binaryTarget(
      name: "libssh2",
      url: "https://github.com/johnmatula/swift-cgit2/releases/download/v1.1.1/libssh2.xcframework.zip",
